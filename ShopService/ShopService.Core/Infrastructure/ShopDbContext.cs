...
{
    public class ShopDbContext(DbContextOptions<ShopDbContext> options, IUserIdAccessor userIdAccessor) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Order>().Property(o => o.CashierId).HasMaxLength(450);
